...
def main():
## Pathes of files ###############################################################################################################
  outPath = "" # Dir to save the output features 
  inputCSV = "" # Path of your csv file, with the columns of "ID", "Image" (path of your image file) and "Mask" (Path of the corresponding binary mask file, one connected-component only)
  outputFilepath = os.path.join(outPath, 'XXX.csv') # path of your param file
  progress_filename = os.path.join(outPath, 'XXX.txt') # path of your param file
  params = "" # path of your param file
