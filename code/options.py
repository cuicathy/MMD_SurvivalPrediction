...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default='Multimodal', help='mode')
    parser.add_argument('--model_name', type=str, default='Test1', help='mode') #AE_feaOnly_test_nodropout_noRecon_again
    ...
    parser.add_argument('--required_modality', type=list, default=[], help='Each sample used for training must have all required_modality available. If required_modality == [], all samples can be used (one modality is available at least)')
    ...
    parser.add_argument('--random_drop_views', type=bool, default=False, help="Modality dropout")
    parser.add_argument('--recon', type=bool, default=False, help="Embedding reconstruction")
